...
var _user$project$Model$MarkdownBlock = {ctor: 'MarkdownBlock'};
var _user$project$Model$DropDown = {ctor: 'DropDown'};
var _user$project$Model$NoAction = {ctor: 'NoAction'};
var _user$project$Model$Nothing = {ctor: 'Nothing'};
...
var _user$project$Model$EditText = function (a) {
		...
		return _elm_lang$core$List$head(
			A2(
				...
				A2(
					...
					function (_p2) {
						var _p3 = _p2;
						return A2(_elm_lang$core$String$startsWith, _p3._1, optionName);
					},
					A2(
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$label,
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'for', 'idofchekc'),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$JsonImporter$questionTypeDecoder = function (string) {
	...
	switch (_p1) {
		...
		case 'markdown':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$MarkdownBlock);
		case 'editbox':
...
var _user$project$JsonImporter$decodeAction = function () {
	var toQuestionAction = F3(
		function (action, number, msg) {
			var _p2 = action;
			switch (_p2) {
				case 'AddQuestion':
...
var _user$project$MarkdownBlockBuilder$options = {
	githubFlavored: _elm_lang$core$Maybe$Just(
...
var _user$project$MarkdownBlockBuilder$buildMarkdownBlock = function (question) {
	return A3(
		_evancz$elm_markdown$Markdown$toHtmlWith,
		_user$project$MarkdownBlockBuilder$options,
		{
			ctor: '::',
...
var _user$project$View$viewQuestionItem = function (questionRecord) {
	...
	switch (_p0.ctor) {
		...
		case 'MarkdownBlock':
			return _user$project$MarkdownBlockBuilder$buildMarkdownBlock(questionRecord);
		case 'CheckBox':
		...
		switch (_p0.ctor) {
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						questionsInPage: A2(
							_elm_lang$core$List$filter,
							function (i) {
								return !_elm_lang$core$Native_Utils.eq(i, _p0._0);
							},
			...
			case 'AddAlert':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						alertMessages: {ctor: '::', _0: _p0._0, _1: model.alertMessages}
					});
			case 'ClearAlert':
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$processFlags = function (flag) {
	...
	var initialQuestionsList = function () {
		var _p1 = listOfQuestionsResult;
		if (_p1.ctor === 'Ok') {
			return _p1._0;
		} else {
			return {ctor: '[]'};
	...
	var questionsInPageAlert = function () {
		var _p2 = listOfQuestionsOnPageResult;
		if (_p2.ctor === 'Ok') {
			return {ctor: '[]'};
		} else {
			return _elm_lang$core$List$singleton(_p2._0);
		}
	}();
